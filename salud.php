					...
					<div class="col-md-8">
						<main>
							<article class="mg-post">
								<header>
									<a href="#"><img src="images/salud.jpg" alt="" class="img-responsive"></a>
									<h2 class="mg-post-title">Cuidado de la Salud</h2>
								</header>
								<div>
									<p><strong>Atención médica</strong> diseñada para enseñar a las personas cómo  mantener una salud óptima en lugar de simplemente pagar sus  facturas cuando se enferma. Hemos estado identificando la  tecnología médica más avanzada, reclutando a los maestros,  sanadores y médicos más innovadores, y organizando el sistema de  atención médica más completo y dinámico de la historia.</p>

									<p>En realidad, la atención médica debería preocuparse por su  salud. Estamos estableciendo Restoration Health Care, que gira en  torno a las necesidades del individuo mucho antes de que se  enferme.</p>

									<p>Creemos que las personas están viviendo una fracción de la vida  para la que están diseñadas y estamos dedicados a restaurar  nuestra verdadera vitalidad.</p>
