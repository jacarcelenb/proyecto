						...
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li  class="active" ><a href="gia.php">GIA</a></li>
					...
					<div class="col-md-8">
						<main>
							<article class="mg-post">
								<header>
									<a href="#"><img src="images/gia-Logo.png" alt="" class="img-responsive"></a>
									<h2 class="mg-post-title">GIA</h2>
								</header>
								<div>
									<p><strong>La Agencia de Inteligencia Global </strong>fue controlada  anteriormente por diferentes entidades y desde entonces  ha sido depurada y reestructurada para operar como la  Agencia de Aplicación del Repositorio Global. El GIA es  responsable de garantizar que todas las transacciones  que salen del Repositorio Global se utilicen para el Plan  de Restauración.</p>
