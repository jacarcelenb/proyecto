						...
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li  class="active" ><a href="asambleas.php">Asambleas</a></li>
								</ul>
							</li>
							<li class="dropdown">
					...
					<div class="col-md-8">
						<main>
							<article class="mg-post">
								<header>
									<a href="#"><img src="images/asamblea.png" alt="" class="img-responsive"></a>
									<h2 class="mg-post-title">Asambleas Nacionales</h2>
								</header>
								<div>
									<p><strong>Asambleas Nacionales</strong> </p>

<p>La Asamblea cumple la función de Organizar y velar por el cumplimiento de los mandatos de Life Force en los respectivos países; esto se refiere a coordinar cada una de las funciones que se desarrollen en el país respectivo así como: </p>
						
<p>Supervisar el normal funcionamiento de los proyectos individuales y sociales, esto quiere  decir que dichos proyectos se lleven a cabo de acuerdo a lo planificado. Evitar que miembros de Life Force en el país, cobren comisiones o sobornen a personas por los dineros asignados.
</p>

<p>Tendrán a cargo de recibir todas las propuestas de ayuda a la comunidad, que estén enmarcadas en el ámbito social, como drogadicción, trata de personas, pobreza, mejoras en la educación, salud, alimentos, etc y que no producen rentabilidad monetaria. </p>
						
<p>Velaran por el cuidado del planeta, preocupándose de la producción de alimentos
saludable, la no contaminación, la utilización de energías renovables entre muchas otras  cosas. </p>

<p> La asamblea Nacional estará compuesta con el mínimo de miembros que sean capaces de  administrar las diferentes áreas que tenga el respectivo país, así por ejemplo:</p>
						
<p>Agrícola, Salud, Obras Publicas, Social, Seguridad, Justicia, Informática, Finanzas, Comunicaciones, Energía, Hídrica, Medio Ambiente, 
Etc. </p>

<p><strong>ASAMBLEA DEPARTAMENTAL Y COMUNAL</strong></p>

						<p>Las Asambleas Departamentales y Comunales, deberán estar compuesta  por miembros de Life Force, que vivan en la región. </p>
						
						<p>Esta asamblea se reportara con la Asamblea  Nacional, los miembros que la compongan  dependerá de los rubros que requiera la región para  llevar una eficiente labor en cada área.</p>
						
<p><strong>FUNCIONES PRINCIPALES</strong></p>
						
				<p>Las funciones y deberes de algunos miembros de la asambleas serán:</p>
				
						<p><strong>Presidente:</strong> Responsable de dirigir la asamblea nacional, firma  documentos legales, supervisar a otros funcionarios, asambleas y comités.</p>
						
						<p><strong>Vicepresidente: </strong>Apoya al Presidente y otros funcionaros según sea  necesario. </p>
						
						<p><strong>Finanzas:</strong> administrar la área financiera de la Asamblea Nacional. </p>
						
						<p><strong>Seguridad:</strong> Dar seguridad a miembros de Life Force e infraestructura,  como también realizar labores de inteligencia, para evitar robos, sobornos,  etc. </p>
						
						<p><strong>Comunicaciones:</strong> Tendrá como misión el asegurarse de dar información  veraz y correcta al publico del trabajo realizado por Life Force en el país. </p>
						
						<p><strong>Agricultura:</strong> Tendrá como misión el desarrollo de productos sanos y que  estos en su desarrollo no dañen el planeta. </p>
						
						<p><strong>Salud:</strong> Sera el encargado de llevar todas las políticas sobre la salud y  atención de las personas.</p>
						
						<p><strong>Educacion:</strong> Deberá entregar la mejor educación a las persona en sus  diferentes periodos de aprendizaje, en su épocas de formación. </p>
						
						<p><strong>Medio Ambiente:</strong> La misión es la protección total del país, preocupándose  de elaborar políticas que favorezcan la no contaminación de nuestro  planeta. </p>
								</div>
							</article>
						</main>
