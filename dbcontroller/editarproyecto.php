...
if (isset($_POST['update'])) {
 ...
 $query = "UPDATE `proyectos` SET departamento ='$departamento',provincia='$provincia'
 ,tipoproyecto='$tipoproyecto',titulo='$titulo',contenido='$contenido' WHERE id=$id";
 ...
 mysqli_query($conn, $query);
  ...
  header('Location: ../pages/listarproyectos.php');
}
    ...
    <div class="col-md-4 mx-auto">
      ...
      <div class="mg-contact-form-input">
							...
							<div class="mg-contact-form-input">
								...
								<input type="text" class="form-control" id="tipo" name="tipoproyecto" 
								value="<?php echo $tipoproyecto; ?>"
								required >
							</div>
							...
							<div class="mg-contact-form-input">
								...
								<input type="text" class="form-control" id="subject" name="contenido" 
