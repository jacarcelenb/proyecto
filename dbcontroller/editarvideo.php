...
if (isset($_POST['update'])) {
 ...
 $query = "UPDATE `video` SET titulo ='$titulo',descripcion='$contenido' WHERE id=$id";
    ...
    <div class="col-md-4 mx-auto">
      ...
      <div class="mg-contact-form-input">
							...
							<div class="mg-contact-form-input">
								...
								<textarea class="form-control" rows="5" name="descripcion"  required><?php echo $descripcion; ?></textarea>
							</div>
