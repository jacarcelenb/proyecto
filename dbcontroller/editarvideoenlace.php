...
if  (isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = "SELECT * FROM videoenlace WHERE id=$id";
...
if (isset($_POST['update'])) {
 ...
 $query = "UPDATE `videoenlace` SET titulo='$titulo',descripcion='$descripcion',enlace='$enlace' WHERE id=$id";
...
<div class="container p-4">
  <div class="row">
    <div class="col-md-4 mx-auto">
      ...
      <form action="../dbcontroller/editarvideoenlace.php?id=<?php echo $_GET['id']; ?>" method="POST">
