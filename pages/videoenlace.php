...
<head> 
	...
	<div class="mg-page">
			<div class="container">
				<div class="row">
                    <div class="col-lg-9">
						<h2 class="mg-sec-left-title" >Ingrese el nuevo video</h2>
      ...
      <?php session_unset(); } ?>
                        ...
                        <form role="form" method="POST" action="../dbcontroller/crearvideoenlace.php" accept-charset="UTF-8" class="form-horizontal">
							...
							<div class="form-group">
					        	...
					        	<button type="submit" value="Ingresar" name="crear_videoenlace" class="btn btn-dark-main pull-center">Ingresar</button> 
