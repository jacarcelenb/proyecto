							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane fade in active" id="select-room">
									...
									<div class="mg-available-rooms">
										<h2 class="mg-sec-left-title">Estado Plurinacional de Bolivia</h2>
										<div class="mg-avl-rooms">
											<div class="mg-avl-room">
												<div class="row">
													...
													<div class="col-sm-7">
														<h3 class="mg-avl-room-title"><a href="#">Estado Plurinacional de Bolivia</a></h3>
														<p>Estado Plurinacional de Bolivia: acerca de las transformaciones del Estado y la gestión del desarrollo ...</p>
