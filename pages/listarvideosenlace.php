...
$sql = "select * from videoenlace limit ".$start." , ".$perPage." ";
$total = $conn->query("select * from videoenlace")->num_rows;
      ...
      <table class="table table-hover">
		...
		<?php
          ...
          <tr>
            ...
            <td>
              <a href="../dbcontroller/editarvideoenlace.php?id=<?php echo $row['id']?>" class="btn btn-warning">
                <i class="fa fa-address-book">Editar</i>
              </a>
            </td>
            <td>
              <a href="../dbcontroller/eliminarvideoenlace.php?id=<?php echo $row['id']?>" class="btn btn-danger">
