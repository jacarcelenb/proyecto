...
<head> 
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
		...
		<?php if (isset($_SESSION['message']) && $_SESSION['message']=="adminitrador001") { ?>
			<div>
	  ...
	  <?php if (isset($_SESSION['message']) && $_SESSION['message']=="Adminitrador002") { ?>
	  ...
	  <?php if (isset($_SESSION['message']) && $_SESSION['message']=="Adminitrador003") { ?>
		<div class="mg-blog-list">
			<div class="container">
				<div class="row">
					<div class="col-md-4">  
